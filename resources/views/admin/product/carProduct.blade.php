    ...
    <div class="container-fluid">
        ...
        <div class="main-content mt-4">
            <div class="col-md-12">
                <div class="row mb-3">
                    ...
                    <div class="col-md-3 offset-md-3">
                        <a href="{{ route('admin#createProductPage') }}">
                            <button class="btn bg-secondary text-white"> <i class="fa-solid fa-plus mr-2"></i> Create
                                Product</button>
                        </a>
                    </div>
                </div>
                @if (session('successCreate'))
                    <div class="col-6 offset-6">
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <i class="fa-solid fa-check mr-3"></i> {{ session('successCreate') }}
                    ...
                    <table class="table table-data2 text-center">
                        ...
                        <tbody>
                            @foreach ($carlist as $car)
                                <tr class="tr-shadow">
                                    <td class="align-middle"><img src="{{ asset('storage/productsImg/' . $car->image1) }}"
                                    ...
                                    <td class="align-middle">
                                        <div class="table-data-feature d-flex">
                                            <a href="{{ route('admin#detailProduct', $car->id) }}"
                                                class="text-decoration-none">
                                                <button class="item rounded-circle bg-success px-2 border-0 ml-2"
                                                    data-toggle="tooltip" data-placement="top" title="Detail">
                                                    <i class="fa-solid fa-eye text-white"></i>
                                                </button>
                                            </a>
                                            <a href="{{ route('admin#editProduct', $car->id) }}"
                                                class="mx-2 text-decoration-none">
                                                <button class="item rounded-circle bg-info px-2 border-0"
                                                    data-toggle="tooltip" data-placement="top" title="Edit">
                                                    <i class="fa-solid fa-pen text-white"></i>
                                                </button>
                                            </a>
                                            <a href="{{ route('admin#deleteProduct', $car->id) }}"
                                                class=" text-decoration-none">
                                                <button class="item rounded-circle bg-danger px-2 border-0"
                ...
                <div class="mt-2">
                    {{ $carlist->links('pagination::bootstrap-5') }}
                </div>
            </div>
        </div>
