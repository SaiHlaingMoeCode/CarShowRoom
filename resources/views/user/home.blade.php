    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="d-flex me-3">
                ...
                style="color: #34495e; font-style: italic;"  data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span  class="mr-2 d-none d-lg-inline font-weight-bold ">{{ Auth::user()->name }}</span>
                        <img class="img-profile rounded-circle ms-2" src="{{ asset('image/profile-user-svgrepo-com.svg') }}" style="width: 25px; height:35px">
